...
(* OASIS_START *)
(* DO NOT EDIT (digest: 166ff2485d16a4ae28530da5f54b6106) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Signal_fd"];
                      lib_pack = false;
                      lib_internal_modules = ["Sigset"];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\228M\207\187n\165u_\241\000`\253\194W\031b";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
